...
@userge.on_cmd("ydtinfo", about={'header': "Get info from ytdl",
...
@userge.on_cmd("ytdlp", about={'header': "Download from youtube",
...
@userge.on_cmd("ydtdes", about={'header': "Get the video description",
                               'description': 'Get information of the link without downloading',
